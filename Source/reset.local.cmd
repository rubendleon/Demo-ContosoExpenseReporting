...
%powerShellDir%\powershell.exe -NonInteractive -command ".\Setup\reset.environment.ps1"
%powerShellDir%\powershell.exe -NonInteractive -command ".\Setup\cleanup.local.ps1"
%powerShellDir%\powershell.exe -NonInteractive -command ".\Setup\setup.local.ps1"
